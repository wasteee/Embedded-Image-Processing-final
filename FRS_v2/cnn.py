...
CATEGORIES = ["data01_", "data02_", "data03_","other_faces"]
training_data = []
IMG_SIZE = 64

filename = "G:\\FRS\\x_test_2.sav"
x_test = pickle.load(open(filename,'rb'))
filename = "G:\\FRS\\x_train_2.sav"
x_train = pickle.load(open(filename,'rb'))
filename = "G:\\FRS\\y_train_2.sav"
y_train = pickle.load(open(filename,'rb'))
filename = "G:\\FRS\\y_test_2.sav"
